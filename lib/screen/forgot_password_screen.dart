...
class Forgot_Account_State extends State<Forgot_Account> {
  ...
  void _redeem_account() async {
    ...
    await pr.show();
    //"https://icebeary.com/hope4cat/register.php"
    //website need to fill here
    http.post(null, body: {
      "email": _email,
    }).then((res) {
      print(res.body);
      if (res.body == "success") {
        Toast.show(
          "Redeem Account success. An email has been sent to .$_email. Please check your email for OTP verification. Also check in your spam folder.",
          context,
          duration: 4,
